...
class Client(object):
    ...
    def __init__(self, host, version, username, password, port=None,
        ...
        self._session_retries = 5

    @property
    def session_retries(self):
        return self._session_retries

    @session_retries.setter
    def session_retries(self, value):
        self._session_retries = value
